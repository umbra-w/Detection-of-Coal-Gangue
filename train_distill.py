...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=r'runs\train\yolov5s_EfficientViT_dyhead_group_taylor_exp12\weights\prune.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    parser.add_argument('--data', type=str, default=r'data\windows_data.yaml', help='dataset.yaml path')
    ...
    # Prune
    parser.add_argument('--prune_model', default=True, action='store_true', help='is prune model?')
    
    # knowledge distillation arguments
    parser.add_argument('--teacher_weights', type=str, default=r'yolov5l_effViT_dyhead\weights\best.pt', help='initial weights path (teacher)')
    parser.add_argument('--teacher_cfg', type=str, default=r'models\yolov5l_effViT_dyhead.yaml', help='initial model.yaml path (teacher)')
    ...
    parser.add_argument('--logical_loss_type', type=str, default='CloserT', choices=['l2', 'l1', 'AlignSoftTarget', 'CTtargetloss', 'CloserT'], help='logical loss type in kd_loss')
